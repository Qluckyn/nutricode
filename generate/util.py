...
SUBSET_NAMES = {
 ...
 #   'my_dataset': ['normal_front_face', 'normal_left_profile_face', 
  #                  'normal_left_three-quarter_face', 'normal_right_profile_face',
  #                   'normal_right_three-quarter_face']
    #'my_dataset': ['overweight_front_face', 'overweight_left_profile_face', 
                #'overweight_left_three-quarter_face', 'overweight_right_profile_face', 
                #'overweight_right_three-quarter_face']'malnourished_front_face','malnourished_right_three-quarter_face'
    #'my_dataset': ['malnourished_left_profile_face', 
                 #'malnourished_front_face']
    #'malnourished_right_three-quarter_face','malnourished_left_three-quarter_face','malnourished_front_face''malnourished_left_three-quarter_face','malnourished_right_profile_face'
  #  'my_dataset': ['malnourished_front_face', 
  #                 'malnourished_left_profile_face',
   #                'malnourished_left_three-quarter_face',
  #                 'malnourished_right_profile_face',
...
TEMPLATES_SMALL = [
    "a {}photo of a {} with a pure white background.",
    "a {}rendering of a {}",
