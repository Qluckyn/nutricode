...
SUBSET_NAMES = {
    ...
    #'overweight_right_three-quarter_face']
   # 'my_dataset': ['malnourished_front_face', 'malnourished_left_profile_face', 
   # 'malnourished_left_three-quarter_face', 'malnourished_right_profile_face', 
